		...
		<section className="bg-white py-24 border-t border-neutral-100">
			<MaxWidthWrapper>
				...
				<div className="mt-20 pt-12 border-t border-neutral-100">
					...
					<div className="bg-neutral-900 text-white rounded-2xl p-8 md:p-12 text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-8">
						...
						<Link
							href="/contact"
							className="whitespace-nowrap bg-white text-neutral-900 font-bold px-8 py-4 rounded-full hover:bg-neutral-100 transition-colors"
						>
